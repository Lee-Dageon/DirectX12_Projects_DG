...
namespace Vector3
{
	...
	inline float Angle(const XMVECTOR xmvVector1, XMVECTOR&& xmvVector2) { // 수정
	...
	inline XMFLOAT3 TransformCoord(XMFLOAT3& xmf3Vector, const XMMATRIX& xmmtxTransform) // 수정
	{
		XMFLOAT3 xmf3Result;
