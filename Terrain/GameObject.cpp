	...
	xmf4Color) : CGameObject(0)
{
	...
	// 디버그 출력
	//OutputDebugStringA("Terrain: cxBlocks = ");
	//OutputDebugStringA(std::to_string(cxBlocks).c_str());
	//OutputDebugStringA(", czBlocks = ");
	//OutputDebugStringA(std::to_string(czBlocks).c_str());
	//OutputDebugStringA(", m_nMeshes = ");
	//OutputDebugStringA(std::to_string(m_nMeshes).c_str());
	//OutputDebugStringA("\n");
