...
D3D12_RASTERIZER_DESC CShader::CreateRasterizerState()
{
	...
	//d3dRasterizerDesc.FillMode = D3D12_FILL_MODE_WIREFRAME;	//따라하기10
	d3dRasterizerDesc.CullMode = D3D12_CULL_MODE_NONE;
	//d3dRasterizerDesc.CullMode = D3D12_CULL_MODE_NONE;		//따라하기9
...
D3D12_DEPTH_STENCIL_DESC CShader::CreateDepthStencilState()
{
	...
	//d3dDepthStencilDesc.DepthEnable = FALSE; // 따라하기 11번
...
{
	wchar_t Shader[] = L"Shaders.hlsl"; //수정
