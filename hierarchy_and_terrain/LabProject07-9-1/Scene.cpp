...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	pApacheObject->SetPosition(+130.0f, 50.0f, 160.0f); // 지형 위로 올림
	...
	pApacheObject->SetChild(pApacheModel, true);
	pApacheObject->OnInitialize();
	pApacheObject->SetPosition(-75.0f, 50.0f, 80.0f); // 지형 위로 올림
	pApacheObject->SetScale(1.5f, 1.5f, 1.5f);
	pApacheObject->Rotate(0.0f, -90.0f, 0.0f);
	...
	pGunshipObject->SetPosition(135.0f, 80.0f, 220.0f); // 지형 위로 올림
	pGunshipObject->SetScale(8.5f, 8.5f, 8.5f);
	pGunshipObject->Rotate(0.0f, -90.0f, 0.0f);
	m_ppGameObjects[3] = pGunshipObject;
	...
	pSuperCobraObject->SetPosition(95.0f, 80.0f, 50.0f); // 지형 위로 올림
	...
	pMi24Object->SetPosition(-95.0f, 80.0f, 50.0f); // 지형 위로 올림
	...
	pHummerObject->SetPosition(260.0f, 50.0f, 150.0f); // 지형 위로 올림
	pHummerObject->SetScale(18.0f, 18.0f, 18.0f);
	pHummerObject->Rotate(0.0f, -90.0f, 0.0f);
	m_ppGameObjects[6] = pHummerObject;
	...
	pTankObject->SetPosition(200.0f, 50.0f, 100.0f); // 지형 위로 올리고 위치 조정
	pTankObject->SetScale(18.0f, 18.0f, 18.0f);
	pTankObject->Rotate(0.0f, -90.0f, 0.0f);
	m_ppGameObjects[7] = pTankObject;
...
bool CScene::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		switch (wParam)
		{
		case 'W': m_ppGameObjects[1]->MoveForward(+5.0f); break; // 첫 번째 아파치 조종 - 속도 5배 증가
		case 'S': m_ppGameObjects[1]->MoveForward(-5.0f); break;
		case 'A': m_ppGameObjects[1]->MoveStrafe(-5.0f); break;
		case 'D': m_ppGameObjects[1]->MoveStrafe(+5.0f); break;
		case 'Q': m_ppGameObjects[1]->MoveUp(+5.0f); break;
		case 'R': m_ppGameObjects[1]->MoveUp(-5.0f); break;
		default:
			break;
		}
		break;
